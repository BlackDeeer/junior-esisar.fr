        ...
        <div className="text-center p-16 bg-white w-3/4">
            ...
            Depuis sa création en 1995, les étudiants ont bénéficié de l'expertise technique de l'école &nbsp;
                <span className="before:shadow-md before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-purple-esisar-500 relative inline-block z-1000">
                    <span className="relative text-white">Grenoble-INP ESISAR, UGA</span>
                </span>. 
            </p>
            <p className="text-lg">
            Nous nous améliorons sans cesse au fil des années afin de vous mettre en relation avec nos meilleurs étudiants pour réaliser vos projets. Nos membres sont passionnés, engagés et votre satisfaction est le cœur de nos préoccupations.
            </p>
        </div>
    </div>
);
