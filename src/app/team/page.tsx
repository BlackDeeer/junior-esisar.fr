        ...
        <div className='mx-auto mt-12 flex max-w-4xl flex-col md:flex-row'>
          <div className='mr-20 mt-6 flex-1 md:ml-2 md:mt-0'>
            ...
            <p>
              ...
              Elit duis tristique sollicitudin nibh. Justo eget magna fermentum
              iaculis eu. Condimentum id venenatis a condimentum vitae. Lobortis
        ...
        <div className='mx-auto mt-12 flex max-w-4xl flex-col md:flex-row'>
          ...
          <div className='mt-6 flex-1 md:ml-2 md:mt-0'>
            ...
            <p>
              ...
              interdum varius sit amet. Ipsum a arcu cursus vitae congue mauris
              rhoncus. Mi eget mauris pharetra et ultrices. Sit amet risus
              nullam eget felis eget nunc. Integer vitae justo eget magna
              fermentum iaculis eu non diam. Ultrices neque ornare aenean
              euismod elementum nisi. Etiam tempor orci eu lobortis elementum
              nibh.
            </p>
          </div>
        </div>
